The code for the hourly graphs, prints the vertical concentration of SO_4 int the Atmosphere (location near Thrakomakedones, Attiki, Greece). 

For each hour, a new figure in a seperate window is created.
